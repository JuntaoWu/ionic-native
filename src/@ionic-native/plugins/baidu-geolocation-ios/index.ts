 ...
 */
@Plugin({
  pluginName: 'BaiduGeolocationIOS',
  plugin: 'cordova-plugin-geolocation-orz',
  pluginRef: 'navigator.geolocation',
  repo: 'https://github.com/JuntaoWu/cordova-plugin-geolocation-baidu',
  install: 'ionic cordova plugin add cordova-plugin-geolocation-orz --variable BAIDUMAPKEY="Ig80XWHvwEtfvrP6HAtIrkdV4WE1HwLC"',
  installVariables: ['BAIDUMAPKEY'],
  platforms: ['iOS']
})
@Injectable()
export class BaiduGeolocationIOS extends IonicNativePlugin {
